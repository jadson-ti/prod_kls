...
-- Copiando estrutura para procedure prod_kls.PRC_RETORNO_NT2_EST
DELIMITER //
CREATE DEFINER=`fsantini`@`%` PROCEDURE `PRC_RETORNO_NT2_EST`()
BEGIN
   ...
   DECLARE CONTINUE HANDLER
	...
	DROP TABLE IF EXISTS tbl_retorno_nt2_est;


	CREATE TABLE tbl_retorno_nt2_est (
   ...
   CREATE INDEX idx_NT_ED1 ON tbl_retorno_nt2_est (SHORTNAME);



	START TRANSACTION;
	
		INSERT INTO tbl_retorno_nt2_est (CD_INSTITUICAO, NM_IES, CD_PESSOA, USERNAME, NOME_USUARIO, COURSE_ID, SHORTNAME,
	...
	START TRANSACTION;
		...
		DELETE ed1 FROM tbl_retorno_nt2_est ed1
	...
	START TRANSACTION;
		...
		UPDATE tbl_retorno_nt2_est ed1
