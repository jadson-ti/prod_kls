...
-- Copiando estrutura para tabela prod_kls.bkp_lms_pessoa_curso_disc
CREATE TABLE IF NOT EXISTS `bkp_lms_pessoa_curso_disc` (
  `id_pes_cur_disc` bigint(20) NOT NULL,
  `id_pessoa` bigint(20) NOT NULL,
  `id_curso_disciplina` bigint(20) NOT NULL,
  `tipo_matricula` varchar(1) CHARACTER SET utf8 DEFAULT NULL,
