...
-- Copiando estrutura para tabela prod_kls.bkp_local_mail_massive
CREATE TABLE IF NOT EXISTS `bkp_local_mail_massive` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Table of massive mail';
