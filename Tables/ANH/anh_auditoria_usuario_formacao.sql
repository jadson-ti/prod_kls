...
-- Copiando estrutura para tabela prod_kls.anh_auditoria_usuario_formacao
CREATE TABLE IF NOT EXISTS `anh_auditoria_usuario_formacao` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `usuario_tutor` int(11) DEFAULT NULL,
