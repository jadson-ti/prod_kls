...
-- Copiando estrutura para tabela prod_kls.sgt_alert_oferta
CREATE TABLE IF NOT EXISTS `sgt_alert_oferta` (
  ...
  `OfertaAntiga` varchar(255) DEFAULT NULL,
  `OfertaAtual` varchar(255) DEFAULT NULL,
