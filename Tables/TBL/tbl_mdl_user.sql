...
-- Copiando estrutura para tabela prod_kls.tbl_mdl_user
CREATE TABLE IF NOT EXISTS `tbl_mdl_user` (
...
) ENGINE=InnoDB AUTO_INCREMENT=373281 DEFAULT CHARSET=utf8 COMMENT='One record for each person';
