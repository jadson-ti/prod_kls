...
-- Copiando estrutura para tabela prod_kls.mdl_task_scheduled
...
) ENGINE=InnoDB AUTO_INCREMENT=105 DEFAULT CHARSET=utf8 COMMENT='List of scheduled tasks to be run by cron.';
