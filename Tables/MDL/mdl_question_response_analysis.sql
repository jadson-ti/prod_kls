...
-- Copiando estrutura para tabela prod_kls.mdl_question_response_analysis
CREATE TABLE IF NOT EXISTS `mdl_question_response_analysis` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='Analysis of student responses given to questions.';
