...
-- Copiando estrutura para tabela prod_kls.mdl_editor_atto_autosave
...
) ENGINE=InnoDB AUTO_INCREMENT=1782718 DEFAULT CHARSET=utf8 COMMENT='Draft text that is auto-saved every 5 seconds while an edito';
