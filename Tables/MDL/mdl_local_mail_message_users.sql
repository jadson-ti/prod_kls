...
-- Copiando estrutura para tabela prod_kls.mdl_local_mail_message_users
CREATE TABLE IF NOT EXISTS `mdl_local_mail_message_users` (
...
) ENGINE=InnoDB AUTO_INCREMENT=7844027 DEFAULT CHARSET=utf8 COMMENT='-';
