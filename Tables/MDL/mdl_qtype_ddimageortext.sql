...
-- Copiando estrutura para tabela prod_kls.mdl_qtype_ddimageortext
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='Defines drag and drop (text or images onto a background imag';
