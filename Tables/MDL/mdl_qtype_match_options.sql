...
-- Copiando estrutura para tabela prod_kls.mdl_qtype_match_options
...
) ENGINE=InnoDB AUTO_INCREMENT=187 DEFAULT CHARSET=utf8 COMMENT='Defines the question-type specific options for matching ques';
