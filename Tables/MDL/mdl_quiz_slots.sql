...
-- Copiando estrutura para tabela prod_kls.mdl_quiz_slots
...
) ENGINE=InnoDB AUTO_INCREMENT=298556 DEFAULT CHARSET=utf8 COMMENT='Stores the question used in a quiz, with the order, and for ';
