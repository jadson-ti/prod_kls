...
-- Copiando estrutura para tabela prod_kls.mdl_quiz
CREATE TABLE IF NOT EXISTS `mdl_quiz` (
  ...
  `showblocks` smallint(4) NOT NULL DEFAULT '1',
  `completionattemptsexhausted` tinyint(1) DEFAULT '0',
  `completionpass` tinyint(1) DEFAULT '0',
  `allowofflineattempts` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `mdl_quiz_cou_ix` (`course`)
) ENGINE=InnoDB AUTO_INCREMENT=94203 DEFAULT CHARSET=utf8 COMMENT='The settings for each quiz.';
