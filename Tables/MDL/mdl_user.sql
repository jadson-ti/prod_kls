...
-- Copiando estrutura para tabela prod_kls.mdl_user
CREATE TABLE IF NOT EXISTS `mdl_user` (
  ...
  KEY `mdl_user_use_ix` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=373282 DEFAULT CHARSET=utf8 COMMENT='One record for each person';
