...
-- Copiando estrutura para tabela prod_kls.mdl_local_mail_massive
CREATE TABLE IF NOT EXISTS `mdl_local_mail_massive` (
...
) ENGINE=InnoDB AUTO_INCREMENT=9186079 DEFAULT CHARSET=utf8 COMMENT='Table of massive mail';
