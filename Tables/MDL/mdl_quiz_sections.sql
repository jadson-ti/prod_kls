...
-- Copiando estrutura para tabela prod_kls.mdl_quiz_sections
...
) ENGINE=InnoDB AUTO_INCREMENT=94203 DEFAULT CHARSET=utf8 COMMENT='Stores sections of a quiz with section name (heading), from ';
