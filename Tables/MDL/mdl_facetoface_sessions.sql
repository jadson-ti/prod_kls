...
-- Copiando estrutura para tabela prod_kls.mdl_facetoface_sessions
CREATE TABLE IF NOT EXISTS `mdl_facetoface_sessions` (
  ...
  PRIMARY KEY (`id`),
  KEY `mdl_facesess_fac_ix` (`facetoface`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='A given facetoface activity may be given at different times ';
